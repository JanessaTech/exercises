...
import useERC20Hook, { TransferLog } from "@/hooks/useERC20Hook"
...
export default function Home() {
  const {getBalance, getRecentTransferLogs} = useERC20Hook(tokenAddress, walletAddress)
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const transfers = await getRecentTransferLogs()
        setBalance(balance)
