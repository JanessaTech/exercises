        ...
        switch (bonusType) {
            ...
            case "freeSpins":
                ...
                if (detail != null) {
                    ...
                    String externalCampaignId = detail.get("externalCampaignId") == null || detail.get("externalCampaignId").isNull() ? null : detail.get("externalCampaignId").asText();
                    Integer durationAfterExpiration = detail.get("durationAfterExpiration") == null || detail.get("durationAfterExpiration").isNull() ? null : detail.get("durationAfterExpiration").asInt();
