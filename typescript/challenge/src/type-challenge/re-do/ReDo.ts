...
type StringToUion<S> = S extends `${infer F}${infer R}`
? F | StringToUion<R>
: never
...
type AllCombinations<S extends string> = Com<StringToUion<S>>

type test = StringToUion<'AB'>
type test1 = Com<StringToUion<'AB'>>
