...
const useWallet = () => {
    ...
    const fetchAccountInfo = async () => {
        ...
        try {
            ...
            console.log('failed to fetch account info due to:', error)
        } 
    }
    ...
    const connect = async () => {
        ...
        try {
            ...
            console.log('failed to connect to MetaMask due to', error)
        }finally{
    ...
    return {account, balance, chainId, isConnecting, connected: !!account,
        connect, disconnect}
}
