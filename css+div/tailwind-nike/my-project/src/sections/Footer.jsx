    ...
    <footer className="max-container">
      ...
      flex-wrap max-lg:flex-col">
        ...
        items-start">
          ...
          font-montserrat text-white-400 sm:max-w-sm">Get shoes ready for the new term at your nearest Nike store. Find
      ...
      <div className="flex 
      justify-between 
      text-white-400 mt-20 max-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 
        justify-start 
        items-center gap-2 
