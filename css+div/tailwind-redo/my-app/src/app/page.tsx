        ...
        <div className="md:col-span-1">
          ...
          <ul className={`${showMenu ? '': 'hidden'}`}>
            <li className="group cursor-pointer my-2" onClick={() => setSelect(0)}>
              <div className={`flex justify-end group-hover:text-blue-600 group-hover:border-blue-500
                 border-r-[4px] 
                ${select === 0 ? 'border-blue-500 text-blue-600' : 'border-white-500'}`}>
            ...
            <li className="group cursor-pointer my-2" onClick={() => setSelect(1)}>
              <div className={`flex justify-end group-hover:text-blue-600 group-hover:border-blue-500
                 border-r-[4px] 
                ${select === 1 ? 'border-blue-500 text-blue-600' : 'border-white-500'}`}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                </svg>
                <span className="px-2">Home</span>
        ...
        <div className="md:col-span-2">
          <div className="my-10">
            <div className="flex justify-center md:justify-end">
              <Link href='#' className="text-xl px-2 py-1 rounded-full text-red-500 border-[2px] border-red-400 hover:bg-red-400 hover:text-white transition ease-in-out duration-200">Login</Link>
              <Link href='#' className="text-xl px-2 py-1 rounded-full text-red-500 border-[2px] border-red-400 hover:bg-red-400 hover:text-white transition ease-in-out duration-200 ml-2">Logout</Link>
            </div>
            <div className="my-10">
              <div className="text-6xl font-semibold">Receipes</div>
              <div className="text-sm italic">Janessa</div>
            </div>
            <div>
            ...
            <div className="grid md:grid-cols-3 gap-5 my-2">
              <div className="card">
                ...
                <div className="p-3">
                  <div className="font-semibold">Declisous noodles</div>
                  <div className="text-sm text-zinc-400">By Janessa</div>
                </div>
                <div className="flex bg-zinc-100 rounded-full px-2 py-1 absolute top-2 left-2">
