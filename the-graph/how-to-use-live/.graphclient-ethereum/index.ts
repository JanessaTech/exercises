...
const documentHashMap = {
        "025ac81b81be98e4cb8ed026778049f4f8841492676ee39b247c43787529b3dc": GetMultipleEthereumPoolLiveDataDocument
      }
additionalEnvelopPlugins.push(usePersistedOperations({
  ...
  return {
    ...
    get documents() {
      return [
      {
        document: GetMultipleEthereumPoolLiveDataDocument,
        get rawSDL() {
          return printWithCache(GetMultipleEthereumPoolLiveDataDocument);
        },
        location: 'GetMultipleEthereumPoolLiveDataDocument.graphql',
        sha256Hash: '025ac81b81be98e4cb8ed026778049f4f8841492676ee39b247c43787529b3dc'
      }
    ];
    },
    fetchFn,
...
export type GetMultipleEthereumPoolLiveDataQueryVariables = Exact<{
  poolIds: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type GetMultipleEthereumPoolLiveDataQuery = { uniswapv3_ethereum: Array<Pick<Pool, 'liquidity' | 'tick' | 'sqrtPrice' | 'feeTier' | 'id'>> };
...
export const GetMultipleEthereumPoolLiveDataDocument = gql`
    query GetMultipleEthereumPoolLiveData($poolIds: [ID!]!) @live(interval: 5000) {
  uniswapv3_ethereum: pools(where: {id_in: $poolIds}) {
    ...PoolLiveDataFields
  }
}
    ${PoolLiveDataFieldsFragmentDoc}` as unknown as DocumentNode<GetMultipleEthereumPoolLiveDataQuery, GetMultipleEthereumPoolLiveDataQueryVariables>;


export type Requester<C = {}, E = unknown> = <R, V>(doc: DocumentNode, vars?: V, options?: C) => Promise<R> | AsyncIterable<R>
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    GetMultipleEthereumPoolLiveData(variables: GetMultipleEthereumPoolLiveDataQueryVariables, options?: C): AsyncIterable<GetMultipleEthereumPoolLiveDataQuery> {
      return requester<GetMultipleEthereumPoolLiveDataQuery, GetMultipleEthereumPoolLiveDataQueryVariables>(GetMultipleEthereumPoolLiveDataDocument, variables, options) as AsyncIterable<GetMultipleEthereumPoolLiveDataQuery>;
    }
  };
}
